...
Before you can sell merchandise, you need to tell BandMath what you have in stock.
1. Navigate to the **Merch Inventory** page.
2. Add your products (e.g., T-Shirts, Vinyl, CDs) and specify the cost to produce them and the retail price.
3. BandMath will automatically track your inventory levels as you log sales.
...
![Standings Summary](./assets/standings-summary.png)
