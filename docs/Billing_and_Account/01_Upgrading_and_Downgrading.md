...
![Band Settings](https://itsbandmath.com/automated-assets/12-band-settings.png)

## How to Upgrade

To upgrade your band's workspace:
1. Navigate to our web portal at **account.itsbandmath.com** and log in with your Admin credentials.
2. Select **Upgrade**.
